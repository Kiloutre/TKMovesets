...
Byte* MovesetLoaderT7::ImportForOnline(SharedMemT7_Player& player, Byte* moveset, uint64_t s_moveset)
{
	...
	case GameId_TTT2:
		...
		break;
	case GameId_TREV:
		final_moveset = ImportForOnline_FromTREV(header, moveset, s_moveset);
		break;
	case GameId_T6:
		final_moveset = ImportForOnline_FromT6(header, moveset, s_moveset);
		break;
	default:
...
Byte* MovesetLoaderT7::ImportForOnline_FromTREV(const TKMovesetHeader* header, Byte* moveset, uint64_t s_moveset)
{
	DEBUG_LOG("ImportForOnline_FromTREV()\n");
...
Byte* MovesetLoaderT7::ImportForOnline_FromT6(const TKMovesetHeader* header, Byte* moveset, uint64_t s_moveset)
{
	DEBUG_LOG("ImportForOnline_FromT6()\n");
