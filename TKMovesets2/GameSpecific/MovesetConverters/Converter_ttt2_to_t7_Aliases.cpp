 ...
 std::map<unsigned int, s_propAlias> MovesetConverter::TTT2ToT7::InitAliasDictionary()
{
	...
	{ 204, {.target_id = 221 }}, // Partner character id
	{ 205, {.target_id = 222 }}, // Partner NOT character id
	{ 206, {.target_id = 217 }}, // Unknown U/F+4, 3
	{ 208, {.target_id = 219 }}, // Opponent partner character id
	{ 209, {.target_id = 220 }}, // Opponent partner NOT character id
	...
	{ 0x82db, {.target_id = 0x842f }}, // Right hand anim
	{ 0x82dc, {.target_id = 0x842e }}, // Left hand anim
	{ 0x82dd, {.target_id = 0x8430 }}, // Wing anim
