...
uint32_t EditorT8::CreateNewProjectile()
{
...
uint32_t EditorT8::CreateInputSequence()
{
...
uint32_t EditorT8::CreateInputList()
{
...
uint32_t EditorT8::CreateNewPushbackExtra()
{
...
uint32_t EditorT8::CreateNewPushback()
{
...
uint32_t EditorT8::CreateNewReactions()
{
...
uint32_t EditorT8::CreateNewHitConditions()
{
...
uint32_t EditorT8::CreateNewExtraProperties()
{
...
uint32_t EditorT8::CreateNewMoveBeginProperties()
{
...
uint32_t EditorT8::CreateNewMoveEndProperties()
{
...
uint32_t EditorT8::CreateNewRequirements()
{
...
uint32_t EditorT8::CreateNewVoiceclipList()
{
...
uint32_t EditorT8::CreateNewCancelExtra()
{
...
uint32_t EditorT8::CreateNewCancelList()
{
...
uint32_t EditorT8::CreateNewGroupedCancelList()
{
...
uint32_t EditorT8::CreateNewThrowCamera()
{
...
uint32_t EditorT8::CreateNewCameraData()
{
...
uint32_t EditorT8::CreateNewMove()
{
...
uint32_t EditorT8::CreateNew(EditorWindowType type)
{
	switch (type)
	{
