...
void EditorT8::DeleteCancelExtradata(int id)
{
...
void EditorT8::DeleteReactions(int id)
{
...
void EditorT8::DeletePushback(int id)
{
...
void EditorT8::DeleteInputSequence(int id)
{
...
void EditorT8::DeleteProjectile(int id)
{
...
void EditorT8::DeleteThrowCamera(int id)
{
...
void EditorT8::DeleteCameraData(int id)
{
...
void EditorT8::DeleteMovelistPlayable(int id)
{
...
void EditorT8::DeleteStructures(EditorWindowType type, uint32_t id, size_t listSize)
{
	if (listSize == 0) {
		listSize = 1;
	}
...
void EditorT8::DeleteAnimation(uint64_t anim_offset)
{
...
void EditorT8::DeleteNameBlockString(uint64_t string_offset)
{
