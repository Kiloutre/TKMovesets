...
void EditorT8::Live_OnMovelistDisplayableEdit(int id, EditorInput* field)
{
	...
	{
		std::string convertedBuffer = EditorT8Utils::ConvertMovelistDisplayableTextToGameText(buffer);
...
void EditorT8::Live_OnMovelistPlayableEdit(int id, EditorInput* field)
{
	auto& name = field->name;
	auto& buffer = field->buffer;
...
void EditorT8::Live_OnMovelistInputEdit(int id, EditorInput* field)
{
	auto& name = field->name;
	auto& buffer = field->buffer;
