...
std::vector<TEditor::CancelProjectileReference> EditorT8::ListCancelsProjectilesReferences(unsigned int cancel_start_id) const
{
...
std::vector<TEditor::MoveCancelReference> EditorT8::ListMoveCancelsReferences(unsigned int moveid) const
{
...
std::vector<TEditor::MoveGroupedCancelReference> EditorT8::ListMoveGroupedCancelsReferences(unsigned int moveid) const
{
...
std::vector<TEditor::MoveReactionsReference> EditorT8::ListMoveReactionsReferences(unsigned int moveid) const
{
