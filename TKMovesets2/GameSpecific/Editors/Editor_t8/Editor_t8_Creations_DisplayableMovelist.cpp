...
void EditorT8::DisplayableMVLTranslationReallocate(int32_t offset, int oldSize, int newSize, uint32_t listStart_offset)
{
...
void EditorT8::ModifyMovelistDisplayableTextSize(int32_t offset, int oldSize, int newSize)
{
...
void EditorT8::ModifyMovelistDisplayableSize(unsigned int listStart, const std::vector<int>& ids, const std::set<int>& deletedIds)
{
...
void EditorT8::ModifyMovelistInputSize(unsigned int listStart, const std::vector<int>& ids, const std::set<int>& deletedIds)
{
...
uint32_t EditorT8::CreateNewMvlPlayable()
{
...
uint32_t EditorT8::CreateNewMvlInputs()
{
