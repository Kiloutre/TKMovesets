...
std::vector<InputMap> EditorT8::GetPushbackExtraListInputs(uint16_t id, int listSize, VectorSet<std::string>& drawOrder)
{
...
void EditorT8::SavePushbackExtra(uint16_t id, InputMap& inputs)
{
...
InputMap EditorT8::GetPushbackInputs(uint16_t id, VectorSet<std::string>& drawOrder)
{
	InputMap inputMap;
...
bool EditorT8::ValidatePushbackField(EditorInput* field)
{
...
void EditorT8::SavePushback(uint16_t id, InputMap& inputs)
{
	auto pushback = m_iterators.pushbacks[id];
...
InputMap EditorT8::GetProjectileInputs(uint16_t id, VectorSet<std::string>& drawOrder)
{
	InputMap inputMap;
...
bool EditorT8::ValidateProjectileField(EditorInput* field)
{
	auto& name = field->name;
...
void EditorT8::SaveProjectile(uint16_t id, InputMap& inputs)
{
	auto projectile = m_iterators.projectiles[id];
...
InputMap EditorT8::GetInputSequenceInputs(uint16_t id, VectorSet<std::string>& drawOrder)
{
	InputMap inputMap;
...
bool EditorT8::ValidateInputSequenceField(EditorInput* field)
{
	auto& name = field->name;
...
void EditorT8::SaveInputSequence(uint16_t id, InputMap& inputs)
{
	auto sequence = m_iterators.input_sequences[id];
...
std::vector<InputMap> EditorT8::GetInputListInputs(uint16_t id, int listSize, VectorSet<std::string>& drawOrder)
{
	std::vector<InputMap> inputListMap;
...
void EditorT8::SaveInput(uint16_t id, InputMap& inputs)
{
	auto input = m_iterators.inputs.begin() + id;
...
InputMap EditorT8::GetThrowCameraInputs(uint16_t id, VectorSet<std::string>& drawOrder)
{
	InputMap inputMap;
...
bool EditorT8::ValidateThrowCameraField(EditorInput* field)
{
	auto& name = field->name;
...
void EditorT8::SaveThrowCamera(uint16_t id, InputMap& inputs)
{
	auto throwCamera = m_iterators.throw_datas[id];
...
InputMap EditorT8::GetCameraDataInputs(uint16_t id, VectorSet<std::string>& drawOrder)
{
	InputMap inputMap;
...
void EditorT8::SaveCameraData(uint16_t id, InputMap& inputs)
{
	auto cameraData = m_iterators.camera_datas[id];
...
InputMap EditorT8::GetReactionsInputs(uint16_t id, VectorSet<std::string>& drawOrder)
{
	InputMap inputMap;
...
bool EditorT8::ValidateReactionsField(EditorInput* field)
{
	auto& name = field->name;
...
void EditorT8::SaveReactions(uint16_t id, InputMap& inputs)
{
	auto reaction = m_iterators.reactions[id];
...
std::vector<InputMap> EditorT8::GetHitConditionListInputs(uint16_t id, VectorSet<std::string>& drawOrder)
{
	std::vector<InputMap> inputListMap;
...
void EditorT8::SaveHitCondition(uint16_t id, InputMap& inputs)
{
...
bool EditorT8::ValidateHitConditionField(EditorInput* field)
{
	auto& name = field->name;
...
std::vector<InputMap> EditorT8::GetRequirementListInputs(uint16_t id, VectorSet<std::string>& drawOrder)
{
	std::vector<InputMap> inputListMap;
...
void EditorT8::SaveRequirement(uint16_t id, InputMap& inputs)
{
...
InputMap EditorT8::GetCancelExtraInput(uint16_t id, VectorSet<std::string>& drawOrder)
{
	InputMap inputMap;
...
void EditorT8::SaveCancelExtra(uint16_t id, InputMap& inputs)
{
	auto cancelExtra = m_iterators.cancel_extras[id];
...
std::vector<InputMap> EditorT8::GetCancelListInputs(uint16_t id, VectorSet<std::string>& drawOrder)
{
	std::vector<InputMap> inputListMap;
...
void EditorT8::SaveCancel(uint16_t id, InputMap& inputs)
{
...
bool EditorT8::ValidateCancelField(EditorInput* field)
{
	auto& name = field->name;
...
std::vector<InputMap> EditorT8::GetGroupedCancelListInputs(uint16_t id, VectorSet<std::string>& drawOrder)
{
	std::vector<InputMap> inputListMap;
...
void EditorT8::SaveGroupedCancel(uint16_t id, InputMap& inputs)
{
...
bool EditorT8::ValidateGroupedCancelField(EditorInput* field)
{
	auto& name = field->name;
	...
	if (name == "move_id") {
		...
		if (EditorT8::IsCommandInputSequence(field->buffer))
		{
			int listIdx = EditorT8::GetCommandInputSequenceID(field->buffer);
			return listIdx < (int)m_infos->table.inputCount;
		}
	}
...
std::vector<InputMap> EditorT8::GetMoveStartPropertyListInputs(uint16_t id, VectorSet<std::string>& drawOrder)
{
	std::vector<InputMap> inputListMap;
...
void EditorT8::SaveMoveStartProperty(uint16_t id, InputMap& inputs)
{
...
std::vector<InputMap> EditorT8::GetMoveEndPropertyListInputs(uint16_t id, VectorSet<std::string>& drawOrder)
{
	std::vector<InputMap> inputListMap;
...
void EditorT8::SaveMoveEndProperty(uint16_t id, InputMap& inputs)
{
...
std::vector<InputMap> EditorT8::GetExtrapropListInputs(uint16_t id, VectorSet<std::string>& drawOrder)
{
	std::vector<InputMap> inputListMap;
...
void EditorT8::SaveExtraproperty(uint16_t id, InputMap& inputs)
{
...
std::vector<InputMap> EditorT8::GetVoiceclipListInputs(uint16_t id, VectorSet<std::string>& drawOrder)
{
	std::vector<InputMap> inputListMap;
...
void EditorT8::SaveVoiceclip(uint16_t id, InputMap& inputs)
{
...
InputMap EditorT8::GetMoveInputs(uint16_t id, VectorSet<std::string>& drawOrder)
{
	InputMap inputMap;
...
void EditorT8::SaveMoveName(const char* moveName, gameAddr move_name_addr)
{
...
void EditorT8::SaveMove(uint16_t id, InputMap& inputs)
{
	auto move = m_iterators.moves[id];
...
bool EditorT8::ValidateMoveField(EditorInput* field)
{
	auto& name = field->name;
...
void EditorT8::SaveItem(EditorWindowType type, uint16_t id, InputMap& inputs)
{
...
InputMap EditorT8::GetFormFields(EditorWindowType type, uint16_t id, VectorSet<std::string>& drawOrder)
{
...
std::vector<InputMap> EditorT8::GetFormFieldsList(EditorWindowType type, uint16_t id, VectorSet<std::string>& drawOrder)
{
...
std::vector<InputMap> EditorT8::GetFormFieldsList(EditorWindowType type, uint16_t id, VectorSet<std::string>& drawOrder, int listSize)
{
...
InputMap EditorT8::GetListSingleForm(EditorWindowType type, uint16_t id, VectorSet<std::string>& drawOrder)
{
...
bool EditorT8::ValidateField(EditorWindowType fieldType, EditorInput* field)
{
