...
void EditorT8::Live_OnGroupedCancelEdit(int id, EditorInput* field)
{
	auto& name = field->name;
	auto& buffer = field->buffer;
...
void EditorT8::Live_OnVoiceclipEdit(int id, EditorInput* field)
{
	auto& name = field->name;
	auto& buffer = field->buffer;
...
void EditorT8::Live_OnCancelExtraEdit(int id, EditorInput* field)
{
	auto& name = field->name;
	auto& buffer = field->buffer;
...
void EditorT8::Live_OnExtrapropertyEdit(int id, EditorInput* field)
{
	auto& name = field->name;
	auto& buffer = field->buffer;
...
void EditorT8::Live_OnMoveBeginPropEdit(int id, EditorInput* field)
{
	auto& name = field->name;
	auto& buffer = field->buffer;
...
void EditorT8::Live_OnReactionsEdit(int id, EditorInput* field)
{
	auto& name = field->name;
	auto& buffer = field->buffer;
...
void EditorT8::Live_OnPushbackExtraEdit(int id, EditorInput* field)
{
	auto& name = field->name;
	auto& buffer = field->buffer;
...
void EditorT8::Live_OnInputSequenceEdit(int id, EditorInput* field)
{
	auto& name = field->name;
	auto& buffer = field->buffer;
...
void EditorT8::Live_OnInputEdit(int id, EditorInput* field)
{
	auto& name = field->name;
	auto& buffer = field->buffer;
...
void EditorT8::Live_OnThrowCameraEdit(int id, EditorInput* field)
{
	auto& name = field->name;
	auto& buffer = field->buffer;
...
void EditorT8::Live_OnCameraDataEdit(int id, EditorInput* field)
{
	auto& name = field->name;
	auto& buffer = field->buffer;
...
void EditorT8::Live_OnFieldEdit(EditorWindowType type, int id, EditorInput* field)
{
