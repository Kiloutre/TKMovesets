...
{
	void ConvertDisplayableMovelistOffsets(MvlHead* mvlHead)
	{
	...
	void ConvertMovesetTableOffsets(const TKMovesetHeaderBlocks* offsets, Byte* moveset, gameAddr gameMoveset)
	{
	...
	void ConvertMovesetIndexes(Byte* moveset, gameAddr gameMoveset, const gAddr::MovesetTable* table, const TKMovesetHeaderBlocks* offsets)
	{
	...
	void CorrectMovesetInfoValues(MovesetInfo* info, gameAddr gameMoveset)
	{
