...
const std::map<unsigned int, s_propAlias> cg_propertyAliases = {
	...
	{ 457, {.target_id = 44 }}, // (JIN) Jz_round_RK -> Jz_round_RKbackE
	...
	{ 0x8001, {.target_id = 0x800b }}, // MAPPING
	{ 0x8002, {.target_id = 0x800b }}, // MAPPING
	{ 0x8003, {.target_id = 0x8003 }}, // MAPPING
	{ 0x8004, {.target_id = 0x800b }}, // (BOB_SATSUMA) Ft_Hadoh -> Standing
	{ 0x8006, {.target_id = 0x800b }}, // (STEVE_FOX) Uk_rp_body2 -> Standing
	{ 0x8007, {.target_id = 0x800b }}, // (ARMOR_KING) Ak_t_srp00B -> Standing
	{ 0x8008, {.target_id = 0x8001 }}, // MAPPING
